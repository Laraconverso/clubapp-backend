...
-- PLAYERS
INSERT INTO players (player_fee_paid, player_password_changed, category_id, club_id, role_id, player_birthdate, player_position, user_address, user_dni, user_email, user_lastname, user_name, user_password) VALUES (TRUE, 1, 2011, 1, 2, '1995-05-15', 'Defensor', '123 Main St', '123456789', 'player1@example.com', 'Doe', 'John', 'password1');
INSERT INTO players (player_fee_paid, player_password_changed, category_id, club_id, role_id, player_birthdate, player_position, user_address, user_dni, user_email, user_lastname, user_name, user_password) VALUES (1, 1, 2011, 1, 2, '1994-08-22', 'Midfielder', '456 Elm St', '987654321', 'player2@example.com', 'Smith', 'Alice', 'password2');
INSERT INTO players (player_fee_paid, player_password_changed, category_id, club_id, role_id, player_birthdate, player_position, user_address, user_dni, user_email, user_lastname, user_name, user_password) VALUES (0, 1, 2018, 1, 2, '1996-02-10', 'Forward', '789 Oak St', '456123789', 'player3@example.com', 'Johnson', 'Bob', 'password3');
INSERT INTO players (player_fee_paid, player_password_changed, category_id, club_id, role_id, player_birthdate, player_position, user_address, user_dni, user_email, user_lastname, user_name, user_password) VALUES (0, 0, 2012, 1, 2, '1997-07-30', 'Goalkeeper', '101 Pine St', '789456123', 'player4@example.com', 'Williams', 'Emily', 'password4');
INSERT INTO players (player_fee_paid, player_password_changed, category_id, club_id, role_id, player_birthdate, player_position, user_address, user_dni, user_email, user_lastname, user_name, user_password) VALUES (0, 0, 2014, 1, 2, '1993-11-05', 'Midfielder', '202 Maple St', '321654987', 'player5@example.com', 'Brown', 'Michael', 'password5');
